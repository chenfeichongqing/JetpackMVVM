...
package com.github.chenfeichongqing.mvvmlib.ext.extension

import android.widget.Toast
import com.github.chenfeichongqing.mvvmlib.utilcode.util.Utils
import com.github.chenfeichongqing.mvvmlib.vassonic.SonicRuntimeImpl
...
fun CharSequence.showToast(duration: Int = Toast.LENGTH_SHORT) {
    Toast.makeText(Utils.getApp().applicationContext, this, duration).show()
}
...
fun CharSequence.preCreateSession(): Boolean {
    if (!SonicEngine.isGetInstanceAllowed()) {
        SonicEngine.createInstance(SonicRuntimeImpl(Utils.getApp().applicationContext), SonicConfig.Builder().build())
    }
