...
/**
 * 富文本工具
 * one.text= SpanStringHelper()
.setContent("我是测试数据，sobyyds")
.setForeColorSpan(Color.BLUE,"我是","yyds")
.setForeColorSpan(Color.GREEN,"测试")
.setTextSizeSpan(30,"测试")
.setStrikethroughSpan("测试")
.setForeColorSpan(Color.RED,"数据")
.setUnderlineSpan("数据")
.setTextSizeSpan(25,"sob")
.setTextStyleSpan(Typeface.BOLD,"sob")
.setUnderlineSpan("yyds")
.build()
 */
class SpanStringHelper {
    ...
    fun setImageSpan(
        drawable: Drawable,
        vararg key: String,
        align: Int = ImageSpan.ALIGN_BASELINE
    ): SpanStringHelper {
        setType({ start, end ->
